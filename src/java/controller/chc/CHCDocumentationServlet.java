...
@WebServlet(name = "CHCDocumentationServlet", urlPatterns = {"/chc/documentation"})
public class CHCDocumentationServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("/WEB-INF/jsp/chc/CHCDocumentation.jsp").forward(request, response);
