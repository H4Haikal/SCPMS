<%-- 
    Document   : AdvisorDocumentation
    Created on : 22 Jun 2026, 2:00:23 pm
    Author     : User
--%>
...
<html lang="en">
    <head>
        ...
        <title>Advisor Documentation | UMT ClubSphere</title>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h3 class="fw-bold mb-0 text-primary">
                            <i class="fas fa-book-open me-2 d-none d-lg-inline"></i>Documentations & Guidelines
                        </h3>
                        <p class="text-muted small mb-0 mt-1">Access important university guidelines, event proposal manuals, and E-Risk documentation here.</p>
                    </div>
                </div>
            ...
            <div class="row g-4">
                <c:choose>
                    <c:when test="${not empty groupedDocs}">
                        <%-- LOOP 1: Create a Bento Card for Every Category --%>
                            ...
                            <div class="col-lg-6">
                                <div class="bento-card p-4 h-100">
                                    ...
                                    <div class="d-flex align-items-center mb-4">
                                        ...
                                        <%-- The Map Key is the Category Name (e.g., "Event Proposals") --%>
                                        <h5 class="fw-bold text-dark mb-0">${entry.key}</h5>
                                    </div>

                                    <ul class="list-group list-group-flush">
                                        <%-- LOOP 2: List all documents inside this specific category --%>
                                        <c:forEach var="doc" items="${entry.value}">
                                            <li class="list-group-item d-flex justify-content-between align-items-center doc-list-item px-3 py-3 border-0">
                                                <div class="d-flex align-items-center">
                                                    <%-- Dynamic Icon based on FileType --%>
                    ...
                    <%-- Fallback if HEPA hasn't uploaded anything at all --%>
                    <c:otherwise>
                        <div class="col-12 text-center py-5">
                            <i class="fas fa-folder-open fa-4x text-muted opacity-25 mb-3"></i>
                            <h4 class="fw-bold text-dark">No Documents Found</h4>
                            <p class="text-muted">There are currently no guidelines, policies, or examples uploaded by management.</p>
                        </div>
                    </c:otherwise>
                </c:choose>
            </div>
